...
type ProductServiceInterface interface {
	...
	SearchProducts(req *dto.SearchProductsRequest) ([]dto.ProductSearchResponse, *utils.PaginationMeta, error)
}

type CartServiceInterface interface {
	GetCart(userID uint) (*dto.CartResponse, error)
	AddToCart(userID uint, req *dto.AddToCartRequest) (*dto.CartResponse, error)
	UpdateCart(userID, itemID uint, req *dto.UpdateCartItemRequest) (*dto.CartResponse, error)
	RemoveFromCart(userID, itemID uint) error
}

type OrderServiceInterface interface {
	CreateOrder(userID uint) (*dto.OrderResponse, error)
	GetAllOrders(userID uint, page, limit int) ([]dto.OrderResponse, *utils.PaginationMeta, error)
